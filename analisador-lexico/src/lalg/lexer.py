...
class Lexer:
    ...
    Reconhece identificadores, palavras reservadas, números inteiros/reais,
    cadeias, operadores, delimitadores e comentários (`{}`, `(* *)`, `//`).
    O analisador não interrompe no primeiro erro: ele registra diagnósticos e
    continua, permitindo exibir uma lista completa de problemas léxicos.
    """
